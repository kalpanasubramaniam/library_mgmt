...
public class BookDBService {
    ...
    public ArrayList<Book> searchBookByBookName(String bookName) {
        Connection c = null;
        Statement stmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            stmt = c.createStatement();
            String sql = "SELECT * FROM BOOK WHERE UPPER(BOOKNAME) LIKE" + "'%" + bookName.toUpperCase() + "%'";
            ...
            if (rs.next()) {
                books.add(new Book(rs.getInt("BOOKID"),
                        rs.getString("AUTHORNAME"),
                        rs.getInt("PRICE"),
                        rs.getString("BOOKNAME"),
                        rs.getString("DEPARTMENT"),
